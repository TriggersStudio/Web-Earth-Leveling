  ...
  return (
    <section className="w-full py-16 lg:py-24 px-4 sm:px-8 lg:px-16">
      <div className="max-w-[870px] mx-auto flex flex-col lg:flex-row items-stretch justify-center gap-8 lg:gap-[27px]">
        {/* Image Card */}
        <div className="relative w-full lg:w-[298px] lg:shrink-0 aspect-[16/9] lg:aspect-auto rounded-[10px] p-[2px]" style={{ background: "linear-gradient(180deg, #E2E2D6 10%, #160856 70%)" }}>
